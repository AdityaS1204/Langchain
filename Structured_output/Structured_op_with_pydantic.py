...
class Review(BaseModel):
    ...
    sentiment: Literal['negative','positive'] =Field(description="return the sentiment of the review either negative, postive or neutral")
    ...
    name: Optional[str] = Field(default=None,description="wrtie the name of the reviewer")
